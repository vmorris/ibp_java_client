 ...
 * A list of peer IDs
 */
@ApiModel(description = "A list of peer IDs")
...
public class PeerList   {
  ...
  public PeerList peerNames(List<String> peerNames) {
    this.peerNames = peerNames;
    return this;
  }

  public PeerList addPeerNamesItem(String peerNamesItem) {
    this.peerNames.add(peerNamesItem);
    return this;
  }

   /**
   * A list of strings representing peer IDs on a network
   * @return peerNames
  **/
  @ApiModelProperty(example = "null", value = "A list of strings representing peer IDs on a network")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.peerNames, peerList.peerNames);
  }

  @Override
  public int hashCode() {
    return Objects.hash(peerNames);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PeerList {\n");
