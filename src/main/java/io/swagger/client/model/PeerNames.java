...
/**
 * A list of peers that the request should be sent too.  This can be added to any of the POSTs in this document.
 */
@ApiModel(description = "A list of peers that the request should be sent too.  This can be added to any of the POSTs in this document.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2018-03-28T22:08:33.832-05:00")
public class PeerNames extends ArrayList<String>  {
