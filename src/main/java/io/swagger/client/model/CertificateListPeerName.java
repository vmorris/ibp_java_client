...
public class CertificateListPeerName   {
  @SerializedName("certs")
  private List<String> certs = new ArrayList<String>();

  public CertificateListPeerName certs(List<String> certs) {
    this.certs = certs;
    return this;
  }

  public CertificateListPeerName addCertsItem(String certsItem) {
    this.certs.add(certsItem);
    return this;
  }

   /**
   * A list of certificates loaded on the peer
   * @return certs
  **/
  @ApiModelProperty(example = "null", value = "A list of certificates loaded on the peer")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CertificateListPeerName certificateListPeerName = (CertificateListPeerName) o;
    return Objects.equals(this.certs, certificateListPeerName.certs);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificateListPeerName {\n");
