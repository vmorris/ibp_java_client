...
import io.swagger.client.model.ChannelListPeerName;


/**
 * An object where each key is a peer ID and each value is a list of channels the peer has joined
 */
@ApiModel(description = "An object where each key is a peer ID and each value is a list of channels the peer has joined")
...
public class ChannelList   {
  ...
  private ChannelListPeerName peerName = null;

  public ChannelList peerName(ChannelListPeerName peerName) {
  ...
  **/
  ...
  public ChannelListPeerName getPeerName() {
    return peerName;
  }

  public void setPeerName(ChannelListPeerName peerName) {
    this.peerName = peerName;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.peerName, channelList.peerName);
  }
